"""Export the Bloc III Markdown dossier to HTML and PDF."""
...
MARKDOWN_PATH = PROJECT_ROOT / "docs" / "bloc3_dossier_v1.md"
CSS_PATH = PROJECT_ROOT / "assets" / "style" / "pharma_pdf.css"
OUTPUT_DIR = PROJECT_ROOT / "dist"
HTML_PATH = OUTPUT_DIR / "bloc3_dossier_v1.html"
PDF_PATH = OUTPUT_DIR / "bloc3_FALIGANT.pdf"
...
def main() -> int:
    ...
    html_text = build_html(
        MARKDOWN_PATH,
        CSS_PATH,
        "Bloc III - Pilotage d'un projet data pharmaceutique",
    )
